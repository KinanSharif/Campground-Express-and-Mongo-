...
var middleware = require("../middleware"); // it'll automatically require index.js in the folder
...
router.put("/:id",middleware.checkCampgroundOwenership, function(req,res){
	...
	let postValues = req.body.campground;
	Campground.findByIdAndUpdate(id,postValues,function(err,updatedInfo){
		if(err){
			console.log(err);
			res.redirect("/campgrounds");
		}else{
